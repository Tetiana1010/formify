...
const Modal = ({ handleModal }) => {
  const { sender, handleSenderChange, resetSender, handleSave } = useContext(Context);
      ...
      <div className="bg-white p-4 rounded-sm">
        ...
        <form className="grid grid-cols-2 gap-4 pt-4">
          ...
          <div className="flex gap-4">
            ...
            <button className="py-2 px-4 rounded-md bg-blue-600 text-white" onClick={handleSave}>
              Save
            </button>
          </div>
        </form>
